...
public sealed class FrostyProject
{
    ...
    */
    ...
    //public bool IsDirty => AssetManager.GetDirtyCount() != 0 || modSettings.IsDirty;
    public bool IsDirty => modSettings.IsDirty;
    ...
    {
        throw new NotImplementedException("port TODO");
        /*filename = inFilename;
