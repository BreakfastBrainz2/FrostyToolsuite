...
public sealed class PluginManager
{
    ...
    public PluginManager(ILogger logger, PluginManagerType context)
    {
        ...
        if (!Directory.Exists("Plugins"))
        {
            ...
            logger.LogInfo("The \"Plugins\" directory could not be located within the executable's associated directory. Due to some plugins being a necessity for functionality, please retrieve a copy of the needed directory from a clean archive of the editor/mod manager.");
    ...
    public bool IsManagerType(PluginManagerType type) => ManagerType == type;
